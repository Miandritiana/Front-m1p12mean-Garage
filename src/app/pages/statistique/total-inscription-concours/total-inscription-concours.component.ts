...
@Component({
  selector: 'app-total-inscription-concours',
  standalone: true,
  imports: [
      AvatarComponent,
      ButtonDirective,
  ...
  templateUrl: './total-inscription-concours.component.html',
  styleUrl: './total-inscription-concours.component.scss'
})
export class TotalInscriptionConcoursComponent {

  chartType: ChartType = 'doughnut';
  totalInscriptionsData!: ChartConfiguration['data'];
  statistiqueConcours: StatistiqueConcours = new StatistiqueConcours();
  ...
  getChart() {
    this.totalInscriptionsData = {
      ...
      datasets: [
        { 
          data: [
            this.statistiqueConcours.nombreInscriptionValide, 
            this.statistiqueConcours.nombreInscriptionNonValide, 
          ], 
  ...
  getDataStatistiqueConcours() {
    this.statistiqueservice.getStatistiqueConcours().subscribe(
      data => {
        if(data) {
          this.statistiqueConcours = data;
